...
export const CreatePoll = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!title || filtered.length < 2) return;
  ...
  return (
    <div className="h-full flex justify-center items-center animate-fadeInSlow">
      <div className="w-[850px] bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-12">

        <h1 className="text-5xl font-extrabold text-center bg-gradient-to-r from-[#A855F7] to-[#3B82F6] bg-clip-text text-transparent">
          Create New Poll
        </h1>
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-4 rounded-xl bg-gradient-to-r from-[#3B82F6] to-[#A855F7] font-bold"
          >
